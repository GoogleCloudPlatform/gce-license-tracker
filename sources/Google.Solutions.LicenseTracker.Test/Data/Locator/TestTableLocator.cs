...
{
    [TestFixture]
    public class TestTableLocator 
    {
        [Test]
        public void WhenReferencesAreEquivalent_ThenEqualsReturnsTrue()
        {
            var ref1 = new TableLocator("proj", "dataset-1", "table-1");
            var ref2 = new TableLocator("proj", "dataset-1", "table-1");
        ...
        {
            var ref1 = new TableLocator("proj-1", "dataset-1", "table-1");
            var ref2 = new TableLocator("proj-2", "dataset-1", "table-1");
