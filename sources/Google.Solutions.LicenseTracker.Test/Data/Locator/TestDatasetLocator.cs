...
{
    [TestFixture]
    public class TestDatasetLocator 
    {
        [Test]
        public void WhenReferencesAreEquivalent_ThenEqualsReturnsTrue()
        {
            var ref1 = new DatasetLocator("proj", "dataset-1");
            var ref2 = new DatasetLocator("proj", "dataset-1");
        ...
        {
            var ref1 = new DatasetLocator("proj-1", "dataset-1");
            var ref2 = new DatasetLocator("proj-2", "dataset-1");
