    ...
    internal class ReportDatasetService : IReportDatasetService
    {
        ...
        private static class ViewDefinitions
        {
            ...
            public static string NodeTypeDetails()
            {
                ...
                {
                    new { NodeType = "h3-node-88-352", CoreCount = 88 },
                    new { NodeType = "c3d-node-360-708", CoreCount = 168 },
                    new { NodeType = "c3d-node-360-1440", CoreCount = 168 },
                    new { NodeType = "c3d-node-360-2880", CoreCount = 168 },
